...
- [Quick Start](/docs/quickstart) — Build from source and run a local node
- [Run a Validator](/docs/run-validator) — Join the testnet as a validator
- [Architecture Overview](/docs/architecture) — Deep dive into the system design
- [API Reference](/docs/rpc) — Full JSON-RPC documentation
